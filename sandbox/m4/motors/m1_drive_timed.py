...
#   Tests @ 10 seconds:
#     100 degrees / second  -->  traveled 13.5 inches  -->  1.35 inches /
# second
...
#   Tests @ 5 seconds:
#     500 degrees / second  -->  traveled 28 inches  -->  5.6 inches / second
#     600 degrees / second  -->  traveled 33.25 inches  -->  6.45 inches /
# second
#     700 degrees / second  -->  traveled 38.5 inches  -->  7.7 inches / second
...
def main():
    ...
    while time_s != 0:
        total_sp = int(input("Enter a speed (0 to 900 dps): "))
